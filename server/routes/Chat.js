...
const { accessChat ,fetchUserAllChats, createGroupChat, renameGroup, addTogroup, removeFromGroup, deleteChat, updateGroupProfile } = require("../controllers/Chat");
...
router.post("/updateGroupProfile", auth, updateGroupProfile);
